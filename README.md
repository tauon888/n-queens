...
## Help
```
$ python n-queens.py -h
usage: n-queens.py [-h] [-n SIZE] [-a]

This program computes the solutions to the n-queens problem. That is, how to place n-queens on a
chessboard, so they cannot take each other.

optional arguments:
  -h, --help            show this help message and exit
  -n SIZE, --size SIZE  size of board
  -a, --all             compute/print non-unique solutions
$
```
...
```
$ python n-queens.py
N-Queens Solver V1.0
Finding unique solutions using a 8x8 board...
