...
## Statistics
| Board Size | Unique Solutions<sup>1</sup> | Total Solutions<sup>2</sup> | Run Time<sup>3</sup> | Run Time<sup>4</sup> |
| ---------: | ---------------------------: | --------------------------: | :------------------: | :------------------: |
...
- Note <sup>3</sup> - Timings based on my original diagonal checking
- Note <sup>4</sup> - Timings based on Neetcode's diagonal checking
